...
class Product {
  ...
  static async addProduct(client, product_name, price, quantity) {
    try {
      ...
      console.log(`There was an error adding ${product_name}`);
      throw error;
    }
  }
  ...
  try {
    const queryString = 'SELECT * FROM products ORDER BY product_name ASC';
